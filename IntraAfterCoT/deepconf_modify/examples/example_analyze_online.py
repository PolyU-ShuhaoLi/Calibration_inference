...
python examples/example_analyze_online.py --output_dir ./online-base-test/ --max_qid 3 --rids base


python examples/example_analyze_online.py --output_dir ./online-dpsk/ --max_qid 29 --rids 1

python examples/example_analyze_online.py --output_dir ./online-base-50/ --max_qid 30 --rids range0




python examples/example_analyze_online.py --output_dir ./online-base7B-30/ --max_qid 30 --rids range0

python examples/example_analyze_online.py --output_dir ./online-base7B-30/ --max_qid 30 --rids range0


python examples/example_analyze_online.py --output_dir ./online-sft7B-30/ --max_qid 30 --rids range0

python examples/example_analyze_online.py --output_dir ./online-rl7B-30/ --max_qid 30 --rids range0


python examples/example_analyze_online.py --output_dir ./online-rl-50/ --max_qid 30 --rids range0


python examples/example_analyze_online.py --output_dir ./online-rl/ --max_qid 50 --rids range0
python examples/example_analyze_online.py --output_dir ./online-sft/ --max_qid 50 --rids range0



python examples/example_analyze_online.py --output_dir /eds-storage/shuhaoli_calibration/deepconf_0112/online-base-aime --max_qid 29 --rids range0

python examples/example_analyze_online.py --output_dir /eds-storage/shuhaoli_calibration/deepconf_0112/online-rl-aime --max_qid 29 --rids range0

python examples/example_analyze_online.py --output_dir /eds-storage/shuhaoli_calibration/deepconf_0112/online-sft-rl1.5-aime --max_qid 29 --rids range0

python examples/example_analyze_online.py --output_dir /eds-storage/shuhaoli_calibration/deepconf_0112/online-sft-qwq1.8-aime --max_qid 29 --rids range0
