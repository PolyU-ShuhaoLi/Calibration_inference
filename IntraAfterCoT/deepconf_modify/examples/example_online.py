...
def main():
    ...
    # Decide qid list
    if args.qid_start is not None or args.qid_end is not None:
        qid_start = 0 if args.qid_start is None else args.qid_start
        qid_end = (len(data)-1) if args.qid_end is None else args.qid_end
        qids = range(qid_start, qid_end + 1)
    else:
        qids = [args.qid]
